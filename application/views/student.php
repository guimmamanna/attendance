...
<div class="wthree_agile_admin_info">
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												<span class="prfil-img"><img src="<?php echo base_url(); ?>inner_css/images/a1.jpg" alt=""> </span> 
											</div>	
										</a>
		...
		<!-- /inner_content-->
				<div class="inner_content">
                    ...
                    <div class="w3l_agileits_breadcrumbs">
							<div class="w3l_agileits_breadcrumbs_inner">
								<ul>
                                    ...
                                    <li><a href="<?php echo base_url(); ?>index.php/Modules">Modules</a><span>«</span></li>
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">Student Attendances</h2>
                        
          <div class="panel-body">
               <div class="row">
              
				<div class="col-sm-12">
					<form method="get" class="form-inline" action="<?php echo base_url(); ?>index.php/Student/load_data">
             
                        <div class="form-group">
                            <select name="Student"  id="student_dropdown" class=" input-sm">
								<option value="0">Select Student</option>
								<?php
							foreach($studentData as $row)
								{
									if(isset($_GET["Student"]) && $_GET["Student"]==$row->Student_Id)
										$select = "selected=selected";
									else
										$select = "";

									echo "<option value='".$row->Student_Id."' ".$select.">".$row->FirstName."</option>";
								}
								?>
			...
			<div class="row" id="table">
				<div class="col-sm-12">
                  <table c border="1" text-align: center; class="table table-condensed table-bordered mg-b-0">
						<thead>
						<tr>
                            <th>#</th>
                            <th>Class Id</th>
						...
						if(isset($attendances)){
							...
							foreach($attendances as $row)
							{
								...
								<tr>
                                   ...
                                   <td><?php echo $row->numOfAttendance; ?></td>
      						</tr>
  ...
  $att++;
            ...
            ?>
                            ...
                            <td colspan="112" align="center"><i class="fa fa-print" style="font-size:36px" aria-hidden="true" style="cursor:pointer" OnClick="CallPrint(this.value)" ></i></td>
...
<script type="text/javascript">
	document.getElementById("student_dropdown").onchange = function () {
		document.getElementById("module_dropdown").value = 0;
		this.form.submit();
	};
	document.getElementById("reset").onclick = function () {
		location.href = "<?php echo base_url(); ?>index.php/Student";
	};
</script>
</html>