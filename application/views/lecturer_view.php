...
<div class="<?php echo base_url(); ?>wthree_agile_admin_info">
 ...
 <div class="container">  
      <br /><br /><br />  
      <h3 align="center">Insert lecturer </h3><br />  
      <form method="post" action="<?php echo base_url()?>index.php/lecturer_controller/form_validation">  
           <?php  
           if($this->uri->segment(2) == "inserted")  
           {  
           //base url - http://localhost/manna/index.php  
           //redirect url - http://localhost/manna//lecturer_controller/inserted  
                //lecturer_controller - segment(1)  
                //inserted - segment(2)  
           ...
           ?>  
            <div class="form-group">  
                <label>Enter Lecturer Id</label>  

                <input type="text" name="Lecturer_Id" value="<?php echo $row->Lecturer_Id; ?>" class="form-control" />  
                <span class="text-danger"><?php echo form_error("Lecturer_Id"); ?></span>  
           </div> 
           <div class="form-group">  
		  ...
		  <div class="form-group">  
                ...
                <input type="text" name="UserName" value="<?php echo $row->Department; ?>" class="form-control" />  
           ...
           <div class="form-group">  
                <input type="hidden" name="hidden_id" value="<?php echo $row->Lecturer_Id; ?>" />  
		  ...
		  <div class="form-group">  
           ...
           <div class="form-group">  
                <label>Enter  Password</label>  
                <input type="int" name="Password" placeholder="Length min 6 max 15 "class="form-control" />  
                <span class="text-danger"><?php echo form_error(" Password"); ?></span>  
           </div>  
           
		   <div class="form-group">  
                <label>Enter Email</label>  
                <input type="text" name="Email" placeholder="Valid email @ "class="form-control" />  
                <span class="text-danger"><?php echo form_error("Email"); ?></span>  
           </div>  
           <div class="form-group">  
                <label>Enter Mobile No.</label>  
      ...
      <br /><br />  
	 <h3 align="center">Lecturer Details </h3><br />  
           ...
           ?>  
                <tr>  
					...
					<td><?php echo $row->Address; ?></td> 
                     ...
                     <td><a href="#" class="delete_data" id="<?php echo $row->Lecturer_Id; ?>">Delete</a></td>  
                     <td><a href="<?php echo base_url(); ?>index.php/lecturer_controller/update_data/<?php echo $row->Lecturer_Id; ?>">Edit</a></td>  
                </tr>  
           <?php       
                }  
           }  
      ...
      $(document).ready(function(){  
           $('.delete_data').click(function(){  
                ...
                {  
                     window.location="<?php echo base_url(); ?>index.php/lecturer_controller/delete_data/"+id;  
                }  
                else  
                {  
                     return false;  
