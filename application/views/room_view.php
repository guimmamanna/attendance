...
<!-- //font-awesome-icons -->
<link href="<?php echo base_url(); ?>//fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800" rel="stylesheet">
</head>
<body>
<!-- banner -->
<div class="<?php echo base_url(); ?>wthree_agile_admin_info">
		  <!-- /w3_agileits_top_nav-->
		  <!-- /nav-->
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
								<li><a href="<?php echo base_url(); ?>main-page.html"> <i class="fa fa-tachometer"></i> Dashboard</a></li>
								<li>
									<a href="#"><i class="fa fa-cogs" aria-hidden="true"></i> UI Components <i class="fa fa-angle-down" aria-hidden="true"></i></a> 
									<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="<?php echo base_url(); ?>buttons.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Buttons</a></li>
										<li class="mini_list_w3"><a href="<?php echo base_url(); ?>grids.html"> <i class="fa fa-caret-right" aria-hidden="true"></i> Grids</a></li>
									</ul>
								</li>
								<li>
								...
								<li><a href="<?php echo base_url(); ?>table.html"> <i class="fa fa-table" aria-hidden="true"></i> Tables</a></li>
								<li><a href="#"><i class="fa fa-list" aria-hidden="true"></i>Short Codes <i class="fa fa-angle-down" aria-hidden="true"> </i></a> 
								     	<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="<?php echo base_url(); ?>typo.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Typography</a></li>
										<li class="mini_list_w3"><a href="<?php echo base_url(); ?>icons.html"> <i class="fa fa-caret-right" aria-hidden="true"></i> Icons</a></li>
				...
				<!-- //nav_agile_w3l -->
				<li class="second logo"><h1><a href="main-page.html"><i class="fa fa-graduation-cap" aria-hidden="true"></i>MANNA </a></h1></li>
					<li class="second admin-pic">
				       <ul class="top_dp_agile">
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="<?php echo base_url(); ?>profile_img">	
												<span class="prfil-img"><img src="<?php echo base_url(); ?>img/admin.jpg" alt=""> </span> 
											</div>	
										</a>
										<ul class="dropdown-menu drp-mnu">
											<li> <a href="#"><i class="fa fa-cog"></i> Settings</a> </li> 
											<li> <a href="#"><i class="fa fa-user"></i> Profile</a> </li> 
											<li> <a href="<?php echo base_url(); ?>index.php/login_controller/logout"><i class="fa fa-sign-out"></i> Logout</a> </li>
										</ul>
									</li>
				   ...
				   <ul class="top_dp_agile ">
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											...
											<li><a href="#">
												<div class="user_img"><img src="<?php echo base_url(); ?>img/a3.jpg" alt=""></div>
											 ...
											 <li class="odd"><a href="#">
												<div class="user_img"><img src="<?php echo base_url(); ?>img/a1.jpg" alt=""></div>
											   <div class="notification_desc">
											     <h6>Mahmoud Gambo</h6>
												<p>Manager</p>
											 ...
											 <li><a href="#">
												<div class="user_img"><img src="<?php echo base_url(); ?>img/a2.jpg" alt=""></div>
											   <div class="notification_desc">
											     <h6>Emeka Alan</h6>
											  ...
											  <li><a href="#">
												<div class="user_img"><img src="<?php echo base_url(); ?>img/a4.jpg" alt=""></div>
											   <div class="notification_desc">
											     <h6>Fernandes Vania</h6>
												<p>Head Lecturer</p>
												<p><span>1 hour ago</span></p>
												</div>
											   <div class="clearfix"></div>	
 ...
 <div class="container">  
      <br /><br /><br />  
      <h3 align="center">Insert room </h3><br />  
      <form method="post" action="<?php echo base_url()?>index.php/room_controller/form_validation">  
           <?php  
           if($this->uri->segment(2) == "inserted")  
           {  
           //base url - http://localhost/manna/index.php  
           //redirect url - http://localhost/manna//room_controller/inserted  
					
                //room_controller - segment(1)  
                //inserted - segment(2)  
		 ...
		 <div class="form-group">  
                ...
                <input type="text" name="Room_Id" value="<?php echo $row->Room_Id; ?>" class="form-control" />  
                <span class="text-danger"><?php echo form_error("Room_Id"); ?></span>  
           </div> 

           <div class="form-group">  
                <label>Enter Room Capacity</label>  
                <input type="text" name="Room_Capacity" value="<?php echo $row->Room_Capacity; ?>" class="form-control" />  
                <span class="text-danger"><?php echo form_error("Room_Capacity"); ?></span>  
           </div>  
           <div class="form-group">  
                <label>Enter Building Name</label>  
                <input type="text" name="BuildingName" value="<?php echo $row->BuildingName; ?>" class="form-control" />  
                <span class="text-danger"><?php echo form_error("BuildingName"); ?></span>  
           </div>  
		  
		  <div class="form-group">  
                <label>Enter Room Number</label>  
                <input type="text" name="RoomNumber" value="<?php echo $row->RoomNumber; ?>" class="form-control" />  
                <span class="text-danger"><?php echo form_error("RoomNumber"); ?></span>  
           </div>  
		   <div class="form-group">  
                <label>Room Description </label>  
                <input type="text" name="RoomDescription" value="<?php echo $row->RoomDescription ; ?>" class="form-control" />  
                <span class="text-danger"><?php echo form_error("RoomDescription"); ?></span>  
           </div>  
		                   
           <div class="form-group">  
                <input type="hidden" name="hidden_id" value="<?php echo $row->Room_Id; ?>" />  
		 ...
		 <div class="form-group">  
           ...
           <div class="form-group">  
                ...
                <input type="int" name="RoomDescription" class="form-control" />  
                <span class="text-danger"><?php echo form_error(" RoomDescription"); ?></span>  
           </div>  
             <div class="form-group">  
      ...
      <br /><br />  
	 <h3 align="center">Room Details </h3><br />  
           ...
           ?>  
                <tr>  
					...
					<td><?php echo $row->RoomDescription; ?></td> 
                     <td><a href="#" class="delete_data" id="<?php echo $row->Room_Id; ?>">Delete</a></td>  
                     <td><a href="<?php echo base_url(); ?>index.php/room_controller/update_data/<?php echo $row->Room_Id; ?>">Edit</a></td>  
                </tr>  
           <?php       
                }  
           }  
      ...
      $(document).ready(function(){  
           $('.delete_data').click(function(){  
                ...
                {  
                     window.location="<?php echo base_url(); ?>index.php/room_controller/delete_data/"+id;  
                }  
                else  
                {  
                     return false;  
	...
	<div class="social_media_w3ls">
						      ...
						      <div class="col-md-3 socail_grid_agile facebook">
									 ...
									 <div class="col-md-4 agile_w3l_social_media_text_img">
									    <img src="<?php echo base_url(); ?>img/admin.jpg" alt="">
									 </div>
							  ...
							  <div class="col-md-3 socail_grid_agile twitter">
									 ...
									 <div class="clearfix"></div>
									  <div class="bottom_info_social">
									 <div class="col-md-4 agile_w3l_social_media_text_img">
									    <img src="<?php echo base_url(); ?>img/a1.jpg" alt="">
									 </div>
									  <div class="col-md-8 agile_w3l_social_media_text">
									    <h4>Mahmoud Gambo</h4>
										<p>Manager</p>
							  ...
							  <div class="col-md-3 socail_grid_agile gmail">
									 ...
									 <div class="clearfix"></div>
									  <div class="bottom_info_social">
									 <div class="col-md-4 agile_w3l_social_media_text_img">
									    <img src="<?php echo base_url(); ?>img/a2.jpg" alt="">
									 </div>
									  <div class="col-md-8 agile_w3l_social_media_text">
									    <h4>Emeka Alan Mark</h4>
										<p>Student president</p>
									 </div>
							  ...
							  <div class="col-md-3 socail_grid_agile dribble">
							     ...
							     <ul class="icon_w3_info">
									 ...
									 <div class="clearfix"></div>
									  <div class="bottom_info_social">
									 <div class="col-md-4 agile_w3l_social_media_text_img">
									    <img src="<?php echo base_url(); ?>img/a4.jpg" alt="">
									 </div>
									  <div class="col-md-8 agile_w3l_social_media_text">
									    <h4>Fernandes Vania</h4>
										<p>Head Lecturer</p>
									 </div>
	 ...
	 <p>Copyright © 2020 All rights reserved | Prowdly
					powered <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#"> MANNA </a> </p>
</div>	
