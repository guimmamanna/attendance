...
<div class="<?php echo base_url(); ?>wthree_agile_admin_info">
 ...
 <div class="container">  
      <br /><br /><br />  
      <h3 align="center">Insert module </h3><br />  
      <form method="post" action="<?php echo base_url()?>index.php/module_controller/form_validation">  
           <?php  
           if($this->uri->segment(2) == "inserted")  
           {  
           //base url - http://localhost/manna/index.php  
           //redirect url - http://localhost/manna//module_controller/inserted  
                //module_controller - segment(1)  
                //inserted - segment(2)  
           ...
           <div class="form-group">  
                ...
                <span class="text-danger"><?php echo form_error("Total_hours"); ?></span>  
           </div>  
		  
		
		                                     
           <div class="form-group">  
                <input type="hidden" name="hidden_id" value="<?php echo $row->Module_Id; ?>" />  
      ...
      <br /><br />  
	 <h3 align="center">Module Details </h3><br />  
      <div class="table-responsive">  
           ...
           ?>  
                <tr>  
                     ...
                     <td><a href="#" class="delete_data" id="<?php echo $row->Module_Id; ?>">Delete</a></td>  
                     <td><a href="<?php echo base_url(); ?>index.php/module_controller/update_data/<?php echo $row->Module_Id; ?>">Edit</a></td>  
                </tr>  
           <?php       
                }  
           }  
      ...
      $(document).ready(function(){  
           $('.delete_data').click(function(){  
                ...
                {  
                     window.location="<?php echo base_url(); ?>index.php/module_controller/delete_data/"+id;  
                }  
                else  
                {  
                     return false;  
