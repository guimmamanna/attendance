...
<div class="wthree_agile_admin_info">
				...
				<div class="inner_content">
                    ...
                    <div class="w3l_agileits_breadcrumbs">
							<div class="w3l_agileits_breadcrumbs_inner">
								<ul>
									<li><a href="<?php echo base_url(); ?>index.php/lecturer">Modules</a><span>«</span></li>
									<li>Module view</li>
								</ul>
							</div>
						</div>
		...
		<div class="panel-body">
         ...
         ?>  
                             ...
                             <td colspan="11" align="center"><i class="fa fa-print" style="font-size:36px" aria-hidden="true" style="cursor:pointer" OnClick="CallPrint(this.value)" ></i></td>
...
<script type="text/javascript">
	document.getElementById("modules_dropdown").onchange = function () {
		//document.getElementById("Practical_dropdown").value = 0;
		this.form.submit();
	};
