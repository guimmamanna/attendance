...
<div class="wthree_agile_admin_info">
		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in" id="table">
					  <h2 class="w3_inner_tittle">Class Attendances</h2>
          ...
          <div class="panel-body">
			...
			<div class="row" >
				<div class="col-sm-12">
                  <table  border="1"  class="table table-condensed table-bordered mg-b-0">
						<thead>
						<tr>
                            <th>#</th>
                            <th>Attendance Id</th>
