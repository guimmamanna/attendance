...
<div class="wthree_agile_admin_info">
		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">Attendance by Class</h2>
		...
		<div class="panel-body">
			<div class="row">
				...
				<div class="col-sm-12">
					<form method="get" class="form-inline" action="<?php echo base_url(); ?>index.php/Classes/load_data">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <select name="classType"  id="classes_dropdown"  class="input-sm">
								<option value="0">Select classtype</option>
								<?php
                                //if($class!=null)
                                //{
			...
			<div class="row" id="table">
						...
						if(isset($attendances)){
							...
							foreach($attendances as $row)
							{
								...
								<tr>
                                   ...
                                   <td><a href="<?php echo base_url(); ?>index.php/view_class_data?classview=<?php echo $row->Class_Id;?>">View</a></td>
             ...
             ?>
                  ...
                  <!--  <div class="card-body card-block">
                                <form action="<?php echo base_url(); ?>index.php/Classes/load_data" method="post" enctype="multipart/form-data" class="form-horizontal" name="bwdatesreport">
