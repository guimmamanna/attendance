				...
				<div class="row align-items-center">
					<div class="col-lg-6 col-sm-6 col-4 header-top-left">
						<a href="tel:+9530123654896">
							...
							<span class="text">
								<span class="text">+447510555294</span>
							</span>
						</a>
						<a href="mailto:manna.ac.uk">
							<span class="lnr lnr-envelope"></span>
							<span class="text">
								<span class="text">manna.ac.uk</span>
							</span>
						</a>
					</div>
					<div class="col-lg-6 col-sm-6 col-8 header-top-right">
						<a href="<?php echo site_url('Student_authentication') ?>" target="_blank" class="text-uppercase">Student</a>
						<a href="<?php echo site_url('authentication') ?>" target="_blank" class="text-uppercase">Lecturer</a>
						<a href="<?php echo site_url('manager_authentication') ?>" target="_blank" class="text-uppercase">Manager</a>
						<a href="<?php echo site_url('login_controller') ?>" target="_blank" class="text-uppercase">Admin</a>
					</div>
				</div>
			</div>
		</div>
	...
	<footer class="footer-area section_gap">
		<div class="container">
			...
			<div class="row footer-bottom d-flex justify-content-between">
				<p class="col-lg-8 col-sm-12 footer-text m-0 text-white">Copyright © 2020 All rights reserved | Prowdly
