...
<div class="<?php echo base_url(); ?>wthree_agile_admin_info">
		  ...
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
				...
				<!-- //nav_agile_w3l -->
				<li class="second logo"><h1><a href=""><i class="fa fa-graduation-cap" aria-hidden="true"></i>MANNA </a></h1></li>
 ...
 <div class="container">  
      <br /><br /><br />  
      <h3 align="center">Update Attendance </h3><br />  
      <form method="post" action="<?php echo base_url()?>index.php/attendance_controller/form_validation">  
           <?php  
           if($this->uri->segment(2) == "inserted")  
           {  
           //base url - http://localhost/manna/index.php  
           //redirect url - http://localhost/manna//attendance_controller/inserted  
                //attendance_controller - segment(1)  
                //inserted - segment(2)  
           ...
           <div class="form-group">  
                <input type="hidden" name="hidden_id" value="<?php echo $row->Attendance_Id; ?>" />  
		   ...
		   <div class="form-group">  
                <label>Enter Status</label>  
                <input type="text" name="Status" placeholder="update student status" class="form-control" />  
                <span class="text-danger"><?php echo form_error("Status"); ?></span>  
           </div>  
      ...
      <br /><br />  
	 <h3 align="center">Attendance Details </h3><br />  
           ...
           ?>  
                <tr>  
					...
					<td><?php echo $row->percent; ?></td> 
                     ...
                     <td><a href="#" class="delete_data" id="<?php echo $row->Attendance_Id; ?>">Delete</a></td>  
                     <td><a href="<?php echo base_url(); ?>index.php/attendance_controller/update_data/<?php echo $row->Attendance_Id; ?>">Edit</a></td>  
                </tr>  
           <?php       
                }  
           }  
      ...
      $(document).ready(function(){  
           $('.delete_data').click(function(){  
                ...
                {  
                     window.location="<?php echo base_url(); ?>index.php/attendance_controller/delete_data/"+id;  
                }  
                else  
                {  
                     return false;  
