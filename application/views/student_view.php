...
<div class="<?php echo base_url(); ?>wthree_agile_admin_info">
 ...
 <div class="container">  
      <br /><br /><br />  
      <h3 align="center">Insert Student </h3><br />  
      <form method="post" action="<?php echo base_url()?>index.php/student_controller/form_validation">  
           <?php  
           if($this->uri->segment(2) == "inserted")  
           {  
           //base url - http://localhost/manna/index.php  
           //redirect url - http://localhost/manna//student_controller/inserted  
                //student_controller - segment(1)  
                //inserted - segment(2)  
		  ...
		  <div class="form-group">  
           ...
           <div class="form-group">  
                <input type="hidden" name="hidden_id" value="<?php echo $row->Student_Id; ?>" />  
		  ...
		  <div class="form-group">  
           ...
           <div class="form-group">  
             ...
             <div class="form-group">  
                ...
                <span class="text-danger"><?php echo form_error("Userame"); ?></span>  
           </div>  
	 ...
	 <h2 align="center">Student Details </h2><br />  
           ...
           ?>  
                <tr>  
					...
					<td><?php echo $row->Address; ?></td> 
                     ...
                     <td><a href="#" class="delete_data" id="<?php echo $row->Student_Id; ?>">Delete</a></td>  
                     <td><a href="<?php echo base_url(); ?>index.php/student_controller/update_data/<?php echo $row->Student_Id; ?>">Edit</a></td>  
                </tr>  
           <?php       
                }  
           }  
      ...
      $(document).ready(function(){  
           $('.delete_data').click(function(){  
                ...
                {  
                     window.location="<?php echo base_url(); ?>index.php/student_controller/delete_data/"+id;  
                }  
                else  
                {  
                     return false;  
