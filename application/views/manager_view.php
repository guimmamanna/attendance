...
<div class="<?php echo base_url(); ?>wthree_agile_admin_info">
		  ...
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
				...
				<!-- //nav_agile_w3l -->
				<li class="second logo"><h1><a href="main-page.html"><i class="fa fa-graduation-cap" aria-hidden="true"></i>Mahmoud</a></h1></li>
   ...
   <h3 align="center">Student below treshold </h3><br />  
      <div class="table-responsive">  
          <table width="auto" class="table table-bordered">
    <tr style="background: #B01515">
