	...
	<div class="wthree_agile_admin_info">
		...
		<div class="inner_content">
			...
			<div class="inner_content_w3_agile_info two_in">
				<h2 class="w3_inner_tittle">Room Capacity</h2>
				<div class="w3ls_agile_circle_progress agile_info_shadow">
					<div class="panel-body">
						<div class="row">

							<div class="col-sm-12">
								<form method="get" class="form-inline" action="<?php echo base_url(); ?>index.php/Rooms/index">
									...
									<div class="form-group">
										<select name="room" id="room" class="form-control input-lg">
											...
											<?php
											foreach ($room as $row) : ?>
												<option value="<?php echo $row->Room_Id; ?>"><?php echo $row->RoomNumber; ?></option>
											<?php endforeach;
											?>
										</select>
									</div>
